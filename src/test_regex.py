from extract.regex import extract_all_info, clean_text

def test_cv_extraction():
    # Sample CV text
    cv_text = """FOOD PREP CHEF
Skills
...
Experience
09/2010 - 04/2011
Company Name City , State Food Prep Chef
...
01/2014 - 12/2014
Company Name City , State Food Service Cook /Temp
...
Education
2011
William M Davies Career & Tech City , State , USA High School Diploma : Culinary/ Auto Body
...
Courses in: Food Preparation, Kitchen Management,Patisserie and Confectionery, International Cuisine"""
    ...
    for exp in info['work_experience']:
        ...
        print(f"Location: {exp['city']}, {exp['state']}")
